...
public class LoginActivity extends AppCompatActivity {
    ...
    public Boolean validateUsername() {
        ...
        if (val.isEmpty()) {
            liusername.setError("Username cannot be empty");
            return false;
        } else {
    ...
    public Boolean validatePassword(){
        ...
        if (val.isEmpty()) {
            lipass.setError("Password cannot be empty");
            return false;
        } else {
    ...
    public void checkUser(){
        String userUsername = liusername.getText().toString().trim();
        String userPassword = lipass.getText().toString().trim();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    if (passwordFromDB.equals(userPassword)) {
                        ...
                        lipass.setError("Invalid Password");
                        lipass.requestFocus();
                    }
                } else {
                    liusername.setError("User does not exist");
